...
Write a program that inserts a substring (s2) before the first occurrence of a given substring (s1) in the primary string (str).

Input Format:
A string str of at most 50 characters. There is no whitespace. 
