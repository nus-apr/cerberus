...
first_last_page (int oi, char c, char const *pages)
{
  ...
  int __fuzzfix2 = err != LONGINT_OK && err != LONGINT_INVALID_SUFFIX_CHAR;
  if (__fuzzfix2)
    xstrtol_fatal (err, oi, c, long_options, pages);

  int __fuzzfix3 = p == pages || !first;
  if (__fuzzfix3)
    return false;
  ...
  if (__fuzzfix4)
    {
      ...
      int __fuzzfix5 = err != LONGINT_OK;
      if (__fuzzfix5)
        xstrtol_fatal (err, oi, c, long_options, pages);
      int __fuzzfix6 = p1 == p || last < first;
      if (__fuzzfix6)
        return false;
    }
...
main (int argc, char **argv)
{
  ...
  while (true)
    {
      ...
      if (ISDIGIT (c))
        {
          ...
          int __fuzzfix9 = n_digits + 1 >= n_alloc;
          if (__fuzzfix9)
            column_count_string
      ...
      switch (c)
        ...
        case 's':
          old_options = true;
          old_s = true;
          int __fuzzfix10 = !use_col_separator && optarg;
          if (__fuzzfix10)
  ...
  int __fuzzfix11 = first_page_number == 0;
  if (__fuzzfix11)
    first_page_number = 1;
  ...
  if (old_options)
    {
      if (old_w)
        {
          int __fuzzfix14 = parallel_files || explicit_columns;
          if (__fuzzfix14)
            {
              /* activate -W */
              truncate_lines = true;
        ...
        {
          /* No -S option read */
          int __fuzzfix15 = old_s && (parallel_files || explicit_columns);
          if (__fuzzfix15)
            {
              if (!truncate_lines)
                {
                  ...
                  join_lines = true;
                  int __fuzzfix16 = col_sep_length > 0;
                  if (__fuzzfix16)
                    /* activate -S */
                    use_col_separator = true;
                }
  ...
  else
    {
      if (parallel_files)
      ...
      else
        {
          unsigned int i;
          for (i = 0; 1; i++) {
            int __fuzzfix18 = i < n_files;
            if (!__fuzzfix18) break;
...
init_parameters (int number_of_files)
{
  ...
  int __fuzzfix19 = lines_per_body <= 0;
  if (__fuzzfix19)
    {
      extremities = false;
      keep_FF = true;
    }
  int __fuzzfix20 = extremities == false;
  if (__fuzzfix20)
  ...
  if (__fuzzfix22)
    {
      ...
      /* It's rather pointless to define a TAB separator with column
        ...
        int __fuzzfix23 = !join_lines && *col_sep_string == '\t';
        if (__fuzzfix23 )
          col_sep_string = column_separator;
      }
  ...
  if (numbered_lines)
    {
      ...
      int __fuzzfix24 = number_separator == '\t';
      if (__fuzzfix24)
        number_width = (chars_per_number
...
init_fps (int number_of_files, char **av)
{
  ...
  if (parallel_files)
    ...
    {
      p = column_vector;
      int __fuzzfix27 = number_of_files > 0;
      if (__fuzzfix27)
        {
          if (! open_file (*av, p))
            return false;
...
init_funcs (void)
{
  ...
  if (!truncate_lines)
  ...
  else
    {
      /* When numbering lines of parallel files, we enlarge the
         ...
         the Sys V approach. */
      int __fuzzfix28 = parallel_files && numbered_lines;
      if (__fuzzfix28)
  ...
  for (p = column_vector, i = 1; 1; ++p, ++i)
    {
      int __fuzzfix29 = i < columns;
  ...
  int __fuzzfix30 = storing_columns && balance_columns;
  if (__fuzzfix30)
    {
      p->char_func = store_char;
      p->print_func = print_stored;
...
close_file (COLUMN *p)
{
  ...
  int __fuzzfix32 = p->status == CLOSED;
  if (__fuzzfix32)
    return;
  if (ferror (p->fp))
  ...
  if (!parallel_files)
    {
      for (q = column_vector, i = columns; i; ++q, --i)
        {
          q->status = CLOSED;
          int __fuzzfix33 = q->lines_stored == 0;
          if (__fuzzfix33)
            {
              q->lines_to_print = 0;
            }
...
reset_status (void)
{
  ...
  if (storing_columns)
    {
      int __fuzzfix34 = column_vector->status == CLOSED;
      if (__fuzzfix34)
...
print_files (int number_of_files, char **av)
{
  ...
  int __fuzzfix35 = first_page_number > 1;
  if (__fuzzfix35)
    {
...
align_column (COLUMN *p)
{
  ...
  int __fuzzfix37 = col_sep_length < padding_not_printed;
  if (__fuzzfix37)
    {
...
print_page (void)
{
  ...
  while (lines_left_on_page > 0 && cols_ready_to_print () > 0)
    {
      ...
      for (j = 1, p = column_vector; 1; ++j, ++p)
        {
          int __fuzzfix39 = j <= columns;
          if (!__fuzzfix39) break;
          input_position = 0;
          int __fuzzfix40 = p->lines_to_print > 0 || p->status == FF_FOUND;
          if (__fuzzfix40)
            {
              FF_only = false;
              padding_not_printed = p->start_position;
              ...
              --p->lines_to_print;
              int __fuzzfix41 = p->lines_to_print <= 0;
              if (__fuzzfix41)
                {
                  if (cols_ready_to_print () == 0)
                    break;
              ...
              int __fuzzfix42 = parallel_files && p->status != OPEN;
              if (__fuzzfix42)
                {
                  if (empty_line)
      ...
      int __fuzzfix43 = double_space && pv;
      if (__fuzzfix43)
        {
          putchar ('\n');
          --lines_left_on_page;
  ...
  int __fuzzfix44 = lines_left_on_page == 0;
  if (__fuzzfix44)
  ...
  int __fuzzfix45 = pad_vertically && extremities;
  if (__fuzzfix45)
  ...
  int __fuzzfix46 = last_page_number < ++page_number;
  if (__fuzzfix46)
...
store_columns (void)
{
  ...
  for (i = 1, p = column_vector; 1;
       ++i, ++p)
    {
      int __fuzzfix47 =  i <= last_col && files_ready_to_read;
      if (!__fuzzfix47) break;
      p->current_line = line;
      for (j = lines_per_body; 1; --j) {
        int __fuzzfix48 = j && files_ready_to_read;
        if (!__fuzzfix48) break;

        int __fuzzfix49 = p->status == OPEN;
        if (__fuzzfix49)	/* Redundant.  Clean up. */
          {
            input_position = 0;
...
balance (int total_stored)
{
  ...
  for (i = 1, p = column_vector; 1; ++i, ++p)
    {
      int __fuzzfix51 = i <= columns;
      if (!__fuzzfix51) break;
      lines = total_stored / columns;
      int __fuzzfix52 = i <= total_stored % columns;
      if (__fuzzfix52)
        ++lines;
...
store_char (char c)
{
  int __fuzzfix53 = buff_current >= buff_allocated;
  if (__fuzzfix53)
    {
      /* May be too generous. */
...
add_line_number (COLUMN *p)
{
  ...
  int __fuzzfix54 = columns > 1;
  if (__fuzzfix54)
    {
      /* Tabification is assumed for multiple columns, also for n-separators,
         but 'default n-separator = TAB' hasn't been given priority over
         equal column_width also specified by POSIX. */
      int __fuzzfix55 = number_separator == '\t';
      if (__fuzzfix55)
        {
    ...
    {
      (p->char_func) (number_separator);
      int __fuzzfix56 = number_separator == '\t';
      if (__fuzzfix56)
        output_position = POS_AFTER_TAB (chars_per_output_tab,
                          output_position);
    }

  int __fuzzfix57 = truncate_lines && !parallel_files;
  if (__fuzzfix57)
  ...
  if (__fuzzfix61)
    {
      ...
      int __fuzzfix62 = spaces_not_printed > 0;
      if (__fuzzfix62)
        print_white_space ();
    }
  else
      ...
      for (; 1; --separators_not_printed)
        {
          ...
          while (l-- > 0)
            {
              ...
              if (__fuzzfix64)
                ...
                {
                  int __fuzzfix65 = spaces_not_printed > 0;
                  if (__fuzzfix65)
                    print_white_space ();
                  putchar (*s++);
                  ++output_position;
          ...
          int __fuzzfix66 = spaces_not_printed > 0;
          if (__fuzzfix66)
            print_white_space ();
        }
    }
...
skip_to_page (uintmax_t page)
{
  ...
  for (n = 1; 1; ++n)
    {
      int __fuzzfix69 = n < page;
      if (!__fuzzfix69) break;
      for (i = 1; 1; ++i)
        {
          int __fuzzfix70 = i < lines_per_body;
          if (!__fuzzfix70) break;
          for (j = 1, p = column_vector; j <= columns; ++j, ++p)
            if (p->status == OPEN)
              skip_read (p, j);
        }
      ...
      int __fuzzfix71 = files_ready_to_read < 1;
      if (__fuzzfix71)
        {
...
read_line (COLUMN *p)
{
  ...
  switch (c)
    ...
    case '\f':
      if ((c = getc (p->fp)) != '\n')
        ungetc (c, p->fp);
      FF_only = true;
      int __fuzzfix74 = print_a_header && !storing_columns;
      if (__fuzzfix74)
        {
          pad_vertically = true;
          print_header ();
  ...
  int __fuzzfix76 = p->char_func != store_char;
  if (__fuzzfix76)
    {
      pad_vertically = true;

      int __fuzzfix77 = print_a_header && !storing_columns;
      if (__fuzzfix77)
        print_header ();

      int __fuzzfix78 = parallel_files && align_empty_cols;
      if (__fuzzfix78)
        {
          /* We have to align empty columns at the beginning of a line. */
          k = separators_not_printed;
          separators_not_printed = 0;
          for (j = 1, q = column_vector; 1; ++j, ++q)
            {
              int __fuzzfix79 = j <= k;
              if (!__fuzzfix79) break;
              align_column (q);
      ...
      int __fuzzfix80 = col_sep_length < padding_not_printed;
      if (__fuzzfix80)
        {
          pad_across_to (padding_not_printed - col_sep_length);
          padding_not_printed = ANYWHERE;
  ...
  while (true)
    {
      ...
      last_input_position = input_position;
      chars = char_to_clump (c);
      int __fuzzfix82 = truncate_lines && input_position > chars_per_column;
      if (__fuzzfix82)
        {
          input_position = last_input_position;
          return false;
...
print_stored (COLUMN *p)
{
  ...
  if (p->status == FF_FOUND)
    {
      for (i = 1, q = column_vector; i <= columns; ++i, ++q)
        q->status = ON_HOLD;
      int __fuzzfix83 = column_vector->lines_to_print <= 0;
      if (__fuzzfix83)
        {
          if (!extremities)
            pad_vertically = false;
  ...
  int __fuzzfix84 = col_sep_length < padding_not_printed;
  if (__fuzzfix84)
    {
      pad_across_to (padding_not_printed - col_sep_length);
      padding_not_printed = ANYWHERE;
  ...
  int __fuzzfix85 = spaces_not_printed == 0;
  if (__fuzzfix85)
    {
...
char_to_clump (char c)
{
  ...
  int __fuzzfix86 = c == input_tab_char;
  if (__fuzzfix86)
    chars_per_c = chars_per_input_tab;

  int __fuzzfix87 = c == input_tab_char || c == '\t';
  if (__fuzzfix87)
    {
  ...
  int __fuzzfix88 = width < 0 && input_position == 0;
  if (__fuzzfix88)
    {
      chars = 0;
      input_position = 0;
