...
def compileit(out_dir, compile_only=False, config_only=False, paraj=0):
    ...
    if not compile_only:
        my_env["CFLAGS"] = "-g -O0 -static -fPIE -Wno-error"
    ...
    if not config_only:
        my_env["CFLAGS"] = "-fsanitize=address -ggdb -fPIC -fPIE -g -O0 -Wno-error"
        my_env["CXXFLAGS"] = "-fsanitize=address -ggdb -fPIC -fPIE -g -O0 -Wno-error"
