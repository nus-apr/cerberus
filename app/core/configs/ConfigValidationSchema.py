...
task_profile_schema = {
    ...
    "properties": {
        ...
        ConfigFieldsEnum.PASSING_TEST_RATIO.value: {"type": "number", "minimum": 0, "maximum": 1}
    },
    "required": [
...
container_profile_schema = {
    ...
    "properties": {
        ...
        ConfigFieldsEnum.MEM_LIMIT.value: {"type": "string", "pattern": "^[1-9][0-9]*[gG]$"},
...
task_default_schema = {
    ...
    "properties": {
        ...
        ConfigFieldsEnum.ONLY_SETUP.value: {
            "type": "boolean"
        },
        ConfigFieldsEnum.REBUILD_ALL.value: {
            "type": "boolean"
        },
        ConfigFieldsEnum.REBUILD_BASE.value: {
            "type": "boolean"
        },
        ConfigFieldsEnum.USE_CACHE.value: {
            "type": "boolean"
        },
        ConfigFieldsEnum.USE_CONTAINER.value: {
            "type": "boolean"
        },
        ConfigFieldsEnum.USE_GPU.value: {
            "type": "boolean"
        },
        ConfigFieldsEnum.USE_PURGE.value: {
            "type": "boolean"
        },
...
tool_config_schema = {
    ...
    "properties": {
        ConfigFieldsEnum.NAME.value: {"type": "string"},
        ConfigFieldsEnum.PARAMS.value: {"type": "object"}
    },
    "required": [ConfigFieldsEnum.NAME.value],
    "additionalProperties": False
}
...
tasks_chunks_schema = {
    ...
    "type": "object",
    "properties": {
        **task_default_schema["properties"],
