...
def emit_help():
    ...
    write("\t" + definitions.ARG_BUG_ID + "\t| " + "run only the specified experiment", WHITE)
    write("\t" + definitions.ARG_BUG_ID_LIST + "\t| " + "runs a list of experiments", WHITE)
    write("\t" + definitions.ARG_START_ID + "\t| " + "specify a range of experiments starting from ID", WHITE)
    write("\t" + definitions.ARG_END_ID + "\t| " + "specify a range of experiments that ends at ID", WHITE)
