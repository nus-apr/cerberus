...
class APRCompVulnC(AbstractBenchmark):
    def __init__(self) -> None:
        self.name = os.path.basename(__file__)[:-3].lower()
        super(APRCompVulnC, self).__init__()
    ...
    def setup_experiment(
        ...
        if self.install_deps(bug_index, container_id):
            is_error = super(APRCompVulnC, self).setup_experiment(
    ...
    def save_artifacts(
        ...
        super(APRCompVulnC, self).save_artifacts(dir_info, container_id)
