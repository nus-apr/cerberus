...
?>
--EXPECTF--
Warning: preg_split() expects at least 2 parameters, 0 given in %s.php on line 3
bool(false)

Warning: preg_split(): Compilation failed: nothing to repeat at offset 0 in %s.php on line 4
bool(false)
array(3) {
  [0]=>
  string(1) "x"
