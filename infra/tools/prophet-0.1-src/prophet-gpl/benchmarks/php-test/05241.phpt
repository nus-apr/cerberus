...
Warning: preg_match_all() expects parameter 2 to be string, object given in %s.php on line %d
bool(false)
NULL

Arg value is: Array

Warning: preg_match_all() expects parameter 2 to be string, array given in %s.php on line %d
bool(false)
NULL
