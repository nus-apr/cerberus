...
Warning: interface_exists() expects at least 1 parameter, 0 given in %s.php on line %d
NULL

-- Testing interface_exists() function with more than expected no. of arguments --

Warning: interface_exists() expects at most 2 parameters, 3 given in %s.php on line %d
NULL
===DONE===