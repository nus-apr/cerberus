...
Warning: imagecreatefromstring(): Empty string or invalid image in %s.php on line %d

Warning: imagecreatefromstring(): Data is not in a recognized format in %s.php on line %d
