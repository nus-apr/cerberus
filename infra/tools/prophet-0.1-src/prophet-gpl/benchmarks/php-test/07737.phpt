...
Warning: array_reduce() expects at most 3 parameters, 4 given in %s.php on line %d
NULL

-- Testing array_reduce() function with less than expected no. of arguments --

Warning: array_reduce() expects at least 2 parameters, 1 given in %s.php on line %d
NULL
===DONE===
