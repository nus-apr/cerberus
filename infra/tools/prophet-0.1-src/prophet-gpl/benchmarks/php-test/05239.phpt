...
Warning: preg_match() expects parameter 2 to be string, array given in %s.php on line %d
bool(false)

Warning: preg_match() expects parameter 2 to be string, object given in %s.php on line %d
bool(false)
Done