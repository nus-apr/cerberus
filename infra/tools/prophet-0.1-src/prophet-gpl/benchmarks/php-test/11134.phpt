...
Warning: pspell_new_config(): PSPELL couldn't open the dictionary. reason: The encoding "b0rked" is not known. This could also mean that the file "%sb0rked.%s" could not be opened for reading or does not exist. in %s.php on line 9

Warning: pspell_check(): 0 is not a PSPELL result index in %s.php on line 10
bool(false)
---
bool(true)
bool(true)
