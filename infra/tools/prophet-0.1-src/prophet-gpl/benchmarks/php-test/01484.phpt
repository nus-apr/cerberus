...
--EXPECTF--
==default
#0  doit(a, b, debug_print_backtrace) called at [%s.php:%d]
#1  foo->doCall(doit, debug_print_backtrace) called at [%s.php:%d]
#2  foo::statCall(doit, debug_print_backtrace) called at [%s.php:%d]
==true
#0  doit(a, b, debug_print_backtrace) called at [%s.php:%d]
#1  foo->doCall(doit, debug_print_backtrace) called at [%s.php:%d]
#2  foo::statCall(doit, debug_print_backtrace) called at [%s.php:%d]
...
#0  doit() called at [%s.php:%d]
#1  foo->doCall() called at [%s.php:%d]
#2  foo::statCall() called at [%s.php:%d]
==both
#0  doit() called at [%s.php:%d]
#1  foo->doCall() called at [%s.php:%d]
#2  foo::statCall() called at [%s.php:%d]
