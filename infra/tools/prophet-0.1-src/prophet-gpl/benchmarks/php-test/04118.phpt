...
?>
--EXPECTF--
Notice: date_default_timezone_set(): Timezone ID 'AAA' is invalid in %s.php on line 4
bool(false)

Notice: date_default_timezone_set(): Timezone ID 'ZZZ' is invalid in %s.php on line 5
bool(false)
bool(true)
bool(true)
done
