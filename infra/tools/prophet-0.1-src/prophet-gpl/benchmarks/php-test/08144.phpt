...
Warning: array_product() expects exactly 1 parameter, 0 given in %s.php on line %d
NULL

-- Testing array_product() function with more than expected no. of arguments --

Warning: array_product() expects exactly 1 parameter, 2 given in %s.php on line %d
NULL
