...
Warning: preg_replace(): Delimiter must not be alphanumeric or backslash in %s.php on line %d
NULL

Arg value is /[a-zA-Z]

Warning: preg_replace(): No ending delimiter '/' found in %s.php on line %d
NULL

Arg value is [a-zA-Z]/

Warning: preg_replace(): Unknown modifier '/' in %s.php on line %d
NULL

Arg value is /[a-zA-Z]/F

Warning: preg_replace(): Unknown modifier 'F' in %s.php on line %d
NULL
...
Catchable fatal error: Object of class stdClass could not be converted to string in %s.php on line %d
