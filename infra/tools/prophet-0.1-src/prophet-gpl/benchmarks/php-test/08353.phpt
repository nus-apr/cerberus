...
--int 0--
Error: 2 - array_multisort(): Argument #3 is expected to be an array or sorting flag that has not already been specified, %s.php(%d)
bool(false)
...
--int 12345--
Error: 2 - array_multisort(): Argument #3 is an unknown sort flag, %s.php(%d)
bool(false)
...
--float 10.5--
Error: 2 - array_multisort(): Argument #3 is expected to be an array or a sort flag, %s.php(%d)
bool(false)
