...
--EXPECTF--
Cannot open archive "%s.php", alias is already in use by existing archive
string(5) "first"

Warning: file_get_contents(phar://%sfile1.txt): failed to open stream: Cannot open archive "%s.php", alias is already in use by existing archive in %s.php on line %d
===DONE===