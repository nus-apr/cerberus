...
Warning: array_count_values() expects exactly 1 parameter, 0 given in %s.php on line 16
NULL

-- Testing array_count_values() function with more than expected no. of arguments --

Warning: array_count_values() expects exactly 1 parameter, 2 given in %s.php on line 22
NULL

-- Testing array_count_values() function integer arguments --

Warning: array_count_values() expects parameter 1 to be array, integer given in %s.php on line 26
NULL
Done