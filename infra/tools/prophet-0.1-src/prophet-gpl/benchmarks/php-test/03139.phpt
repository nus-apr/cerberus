...
Warning: shm_get_var() expects exactly 2 parameters, 0 given in %s.php on line %d
NULL

Warning: shm_get_var() expects parameter 1 to be resource, integer given in %s.php on line %d
NULL

Warning: shm_get_var(): variable key 1000 doesn't exist in %s.php on line %d
bool(false)

Warning: shm_get_var(): variable key -10000 doesn't exist in %s.php on line %d
bool(false)

Warning: shm_get_var() expects parameter 2 to be long, array given in %s.php on line %d
NULL
