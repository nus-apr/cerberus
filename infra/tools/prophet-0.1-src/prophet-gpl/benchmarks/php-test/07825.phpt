...
Warning: array_uintersect_uassoc() expects parameter 5 to be a valid callback, no array or string given in %s.php on line %d
NULL

-- Testing array_uintersect_uassoc() function with less than expected no. of arguments --

Warning: array_uintersect_uassoc(): at least 4 parameters are required, 3 given in %s.php on line %d
NULL
===DONE===
