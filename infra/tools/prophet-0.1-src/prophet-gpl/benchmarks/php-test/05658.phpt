...
Warning: oci_execute(): ORA-00942: %s in %s.php on line %d
Test 3: Using a null byte in a bind variable name

Warning: oci_bind_by_name(): ORA-01036: %s in %s.php on line %d

Warning: oci_execute(): ORA-01008: %s in %s.php on line %d
