...
--EXPECTF--
Notice: Array to string conversion in %s.php on line 6

Warning: fopen(Array): failed to open stream: No such file or directory in %s.php on line 6
blah
test

Warning: fopen(phar://%s.php/oops): failed to open stream: phar error: path "oops" is a directory in phar://%s.php/foo/hi on line 6
===DONE===