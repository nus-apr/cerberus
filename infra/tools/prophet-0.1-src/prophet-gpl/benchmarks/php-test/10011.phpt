...
--EXPECTF--
Mounting of testit to %s.php within phar %s.php failed
Can only mount internal paths within a phar archive, use a relative path instead of "phar://%s.php/testit1"
Mounting of testit to %s.php within phar %sphar_mount.phar.tar failed
Mounting of /oops to /home/oops/../../etc/passwd: within phar %s.php failed
<?php
