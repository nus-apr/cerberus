...
Warning: array_reduce() expects parameter 2 to be a valid callback, function 'bogusbogus' not found or invalid function name in %s.php on line %d
NULL

Warning: array_reduce() expects parameter 1 to be array, string given in %s.php on line %d
NULL

Warning: array_reduce() expects parameter 1 to be array, object given in %s.php on line %d
NULL
===DONE===