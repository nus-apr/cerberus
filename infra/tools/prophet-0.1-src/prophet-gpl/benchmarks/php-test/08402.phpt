...
Warning: array_fill_keys() expects exactly 2 parameters, 3 given in %s.php on line %d
NULL

-- Testing array_fill_keys() function with less than expected no. of arguments --

Warning: array_fill_keys() expects exactly 2 parameters, 1 given in %s.php on line %d
NULL

-- Testing array_fill_keys() function with no argumets --

Warning: array_fill_keys() expects exactly 2 parameters, 0 given in %s.php on line %d
NULL
Done
