...
Warning: preg_replace_callback(): Requires argument 2, '', to be a valid callback in %s.php on line 8
string(0) ""

Warning: preg_replace_callback(): Modifier /e cannot be used with replacement callback in %s.php on line 10
NULL
