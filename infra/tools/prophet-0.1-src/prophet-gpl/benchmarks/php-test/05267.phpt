...
Warning: preg_quote() expects parameter 1 to be string, array given in %s.php on line %d
NULL

Warning: preg_quote() expects parameter 1 to be string, object given in %s.php on line %d
NULL
Done