...
hio
test
alias "test" is already used for archive "%s.php" and cannot be used for other archives
alias "test" is already used for archive "%s.php" cannot be overloaded with "%snope.phar"
===DONE===
