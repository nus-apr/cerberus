...
?>
--EXPECTF--
#0  userErrorHandler(8, Undefined variable: b, %s.php, 11, Array ([A1] => Test1)) called at [%s.php:11]
#1  GenerateError1(Test1) called at [%s.php:16]
#2  GenerateError2(Test2) called at [%s.php:19]
