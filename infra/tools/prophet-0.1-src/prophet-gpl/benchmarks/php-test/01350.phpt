...
Notice: Undefined property: BaseClass::$private_child in %s.php on line %d
NULL
===CHILD===
string(4) "Base"

Fatal error: Cannot access private property ChildClass::$private_child in %s.php on line %d
