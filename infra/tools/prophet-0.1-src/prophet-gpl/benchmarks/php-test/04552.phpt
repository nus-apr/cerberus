...
Warning: dba_open(%stest0.dbm,c): Driver initialization failed for handler: cdb: Update operations are not supported in %s.php on line %d
Failed to open DB
Test 2

Warning: dba_insert(): You cannot perform a modification to a database without proper access in %s.php on line %d
Test 3

Warning: dba_open(%stest0.dbm,w): Driver initialization failed for handler: cdb: Update operations are not supported in %s.php on line %d
Failed to open DB
===DONE===
