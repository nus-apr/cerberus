...
Warning: copy(): The first argument to copy() function cannot be a directory in %s.php on line %d
bool(false)
bool(false)
int(%d)

Warning: filesize(): stat failed for %scopy_copy_variation12 in %s.php on line %d
bool(false)
*** Done ***
