...
Warning: PharFileInfo::__construct() expects parameter 1 to be %string, array given in %s.php on line %d
Cannot access phar file entry '/oops/I/do/not/exist' in archive '%spharfileinfo_construct.phar'
Cannot call constructor twice
'%s.php' is not a valid phar archive URL (must have at least phar://filename.phar)
===DONE===