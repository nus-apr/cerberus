...
Warning: tidy::getOpt(): Unknown Tidy Configuration Option 'bogus-opt' in %s.php on line 10
bool(false)

Warning: tidy_getopt(): Unknown Tidy Configuration Option 'non-ASCII string рсч' in %s.php on line 11
bool(false)
