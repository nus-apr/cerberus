...
--EXPECTF--
Warning: readfile() expects parameter 1 to be string, array given in %s.php on line %d
blah
<?php
readfile("foo/" . basename(__FILE__));
$context = stream_context_create();
...
Warning: readfile(phar://%s.php/oops): failed to open stream: phar error: path "oops" is a directory in phar://%s.php/foo/hi on line %d
===DONE===