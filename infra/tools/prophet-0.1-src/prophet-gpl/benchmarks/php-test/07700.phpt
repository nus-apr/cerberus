...
Strict Standards: array_map() expects parameter 1 to be a valid callback, non-static method SimpleClass::square() should not be called statically in %s.php on line %d
array(2) {
  [0]=>
  int(1)
  [1]=>
...
Warning: array_map() expects parameter 1 to be a valid callback, cannot access private method SimpleClassPri::add() in %s.php on line %d
NULL

-- simple class with protected variable and method --
SimpleClassPro::mul

Warning: array_map() expects parameter 1 to be a valid callback, cannot access protected method SimpleClassPro::mul() in %s.php on line %d
NULL

-- class without members --
EmptyClass

Warning: array_map() expects parameter 1 to be a valid callback, array must have exactly two members in %s.php on line %d
NULL

-- abstract class --
ChildClass::emptyFunction

Strict Standards: array_map() expects parameter 1 to be a valid callback, non-static method ChildClass::emptyFunction() should not be called statically in %s.php on line %d
defined in child
defined in child
array(2) {
  [0]=>
...
Strict Standards: array_map() expects parameter 1 to be a valid callback, non-static method FinalClass::finalMethod() should not be called statically in %s.php on line %d
...
Warning: array_map() expects parameter 1 to be a valid callback, cannot access private method StaticClass::cube() in %s.php on line %d
NULL
StaticClass::retVal

Warning: array_map() expects parameter 1 to be a valid callback, cannot access protected method StaticClass::retVal() in %s.php on line %d
NULL
