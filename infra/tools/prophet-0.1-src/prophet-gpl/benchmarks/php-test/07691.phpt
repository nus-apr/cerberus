...
Warning: array_multisort() expects at least 1 parameter, 0 given in %s.php on line %d
NULL

-- Testing array_multisort() function with repeated flags --

Warning: array_multisort(): Argument #3 is expected to be an array or sorting flag that has not already been specified in %s.php on line %d
bool(false)
