...
===DONE===
--EXPECTF--
Warning: SimpleXMLElement::addAttribute(): Attribute already exists in %s.php on line %d

Warning: SimpleXMLElement::addChild(): Cannot add element to attributes in %s.php on line %d
<?xml version="1.0"?>
