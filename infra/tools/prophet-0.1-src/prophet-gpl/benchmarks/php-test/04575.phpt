...
Notice: dba_popen(): %stest0.dbm: unexpected file type or format in %s.php on line %d

Warning: dba_popen(%stest0.dbm,c): Driver initialization failed for handler: db4: Invalid argument in %s.php on line %d
