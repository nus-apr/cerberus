...
Warning: interface_exists() expects parameter 1 to be string, array given in %s.php on line %d
NULL
...
Warning: interface_exists() expects parameter 1 to be string, object given in %s.php on line %d
NULL
