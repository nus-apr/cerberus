...
Notice: Undefined index:  5th in %s.php on line %d
NULL

Notice: Undefined offset:  6 in %s.php on line %d
NULL
===offsetSet===
WRITE 1
string(9) "Changed 1"
...
Notice: Undefined offset:  7 in %s.php on line %d

Notice: Undefined index:  8th in %s.php on line %d
array(4) {
  [0]=>
  string(3) "1st"
  [1]=>
