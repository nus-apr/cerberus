...
Warning: arsort() expects parameter 2 to be long, string given in %s.php on line %d
bool(false)
array(3) {
  [1]=>
  int(10)
...
Warning: arsort() expects parameter 2 to be long, object given in %s.php on line %d
bool(false)
array(3) {
  [1]=>
  int(10)
...
Warning: arsort() expects parameter 2 to be long, resource given in %s.php on line %d
bool(false)
array(3) {
  [1]=>
  int(10)
