...
?>
--EXPECTF--	
Warning: parse_ini_file() expects at least 1 parameter, 0 given in %s.php on line 6
bool(false)

Warning: parse_ini_file() expects at most 3 parameters, 4 given in %s.php on line 7
bool(false)
