...
Notice: Indirect modification of overloaded element of Peoples has no effect in %s.php on line 46
string(6) "JoeFoo"

Notice: Indirect modification of overloaded element of Peoples has no effect in %s.php on line 48
string(6) "JoeFoo"
===DONE===
