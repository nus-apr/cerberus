...
hi
hi
Entry phar://%s.php/a does not exist and cannot be created: phar error: invalid path "phar://%s.php/a" contains double slash
Entry a does not exist and cannot be created: phar error: file "a" in phar "%s.php" cannot be opened for writing, readable file pointers are open
